function Powered_VSPA_configuration(blue, black)
    clear
    % close all
...
%     ROM_thresh = deg2rad(7);
    ...
    lead_screw = 57.5; %mm
    x_center_min = 30.5; %(mm) most stiff position in spring support stroke --- measured from CAD
    ...
    if(blue)
        spring = 'stiff';
        ta_input = 'poweredVSPA'; %poweredVSPA VSPA
        max_spring = 1;
        max_FEA_only = 1;
    ...
    save('inputs/Powered_VSPA_configuration')
end