function [theta_inv,delta_inv,M_ankle,theta_cam_inv,Angles,Moments,F_cam_3,ROM_index,cam_angles] = inverse_model(preload_inv,kdelt,x_center,x_center_inv,ktranslational,epsilon,mu,y_off,r,psi,gamma,dual_test)
    %% Setup
