function cam_tango_up()
    ...
    %------------------------
    %90 0.6 1.62 0.45 0.66
    %[135 0.6 1.62 0.15 0.66]
    stiffness_dorsi = 135/rad2deg(1); %Nm/deg
    stiffness_trans_1 = 0.3*stiffness_dorsi;
    stiffness_trans_2 = 0.5*stiffness_dorsi;
    stiffness_leveling = 0.15*stiffness_dorsi; %Nm/deg;
