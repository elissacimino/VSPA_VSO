...
characterization_parameter_testing = 0; %allows code to change series compliance and preload in the inverted model, from those use to make cam profile
...
perc_max = 1.0; %maximum percentage testing on JIM
plot_one = 0;
plot_select = 0;
