...
%% Plotting Options
primary_curve_notscaled = 1; %plots scaled primary curve
primary_curve_scaled = 0; %plots primary curve designed by hand with a scale factor of 1
HUMAN = 0;
Collins = 0;
AFO = 0;
cam_forces = 1;
...
if(cam_children)
    kdelt = 250; %(600 used for cam first round of RAMTECH cams) Series stiffness of frame
...
if(cam_nonlin)
    ...
    scalefactor = 0.16; %0.32 stiffest 0.24 middle
    torque_max = 160;
    dorsi_max = 50; 
    plantar_max = -65; 
